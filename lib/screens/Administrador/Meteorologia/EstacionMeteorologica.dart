...
import 'package:helvetasfront/screens/Administrador/Meteorologia/DatosMeteorologicaScreen.dart';
...
class _EstacionMeteorologicaScreenState
  ...
  Future<void> fetchEstaciones() async {
    try {
      final response =
          await http.get(Uri.parse(url + '/estacion/lista_meteorologica'));
